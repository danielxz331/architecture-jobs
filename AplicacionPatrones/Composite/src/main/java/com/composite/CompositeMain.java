...
public class CompositeMain {
    ...
    public static void main(String[] args) {
        CompositeMain mainObject = new CompositeMain();
        mainObject.buildProducts();

        mainObject.orderSimpleProducts();
        mainObject.orderHomePC();
        mainObject.orderGammerPC();
        mainObject.orderCombo();
        mainObject.orderBig();
